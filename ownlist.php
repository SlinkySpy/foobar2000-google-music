...
foreach($ownlists as $ownlist) {
	...
	$output .= "<tr><td bgcolor='$color'><a href='ownlist/$ownlist' style='display:block;float:left;' onclick='a_onclick(this);return false;'>$ownlist_name</a>&nbsp;&nbsp;<span style='font-size:12px;background-color:#333;color:#999;float:right;display:block;padding:2px;cursor:pointer;' onclick='ajax(\"delownlist.php\",\"name=$ownlist\",delownlistresponse);'>删除</span></td><td><span style='font-size:12px;background-color:#666;color:#bbb;float:right;display:block;padding:2px;cursor:pointer;' onclick='globalevent=event;loadsonglist(\"playlist=$ownlist\",\"$ownlist_name\");'>详情</span></td></tr>";
	$i++;
}
$output .= "</table>";
echo $output;
